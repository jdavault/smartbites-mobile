...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const adminEmails = [
      ...
      'jdavault@smartbites.food',
      'kjlobb@smartbites.food',
    ];
      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="detail">
            ...
            <span class="value">${restaurant.contact_name || 'Not provided'}</span>
          </div>
          ...
          <div class="detail">
            ...
            <span class="value">${restaurant.address}<br>${restaurant.city}, ${restaurant.state} ${restaurant.zip_code}</span>
          </div>
          ...
          <div class="detail">
            ...
            <span class="value">${new Date(restaurant.created_at).toLocaleString('en-US', {
              dateStyle: 'full',
              timeStyle: 'short'
            })}</span>
          </div>
          ...
          <div class="button-container">
            <a href="https://allergyawaremenu.com/admin" class="button">
...
Location: ${restaurant.address}, ${restaurant.city}, ${restaurant.state} ${restaurant.zip_code}
Cuisine: ${restaurant.cuisine_type}
Registered: ${new Date(restaurant.created_at).toLocaleString()}

Review in admin portal: https://allergyawaremenu.com/admin
...
`;
    ...
    // Send emails using your SMTP service
    ...
    if (resendApiKey) {
      const resendResponse = await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'SmartBites Notifications <notifications@smartbites.food>',
          to: adminEmails,
